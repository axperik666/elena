...
const FB_CONFIG = require('./fb-config');
...
const ENV_ALIASES = {
  ...
  FB_PIXEL_ID: ['META_PIXEL_ID', 'FACEBOOK_PIXEL_ID'],
  FB_ACCESS_TOKEN: ['META_ACCESS_TOKEN', 'FACEBOOK_ACCESS_TOKEN', 'FB_CAPI_TOKEN']
};
...
function getEnvAny(primary) {
  ...
  if (primary === 'FB_PIXEL_ID' && FB_CONFIG.FB_PIXEL_ID) return FB_CONFIG.FB_PIXEL_ID;
  if (primary === 'FB_ACCESS_TOKEN' && FB_CONFIG.FB_ACCESS_TOKEN) return FB_CONFIG.FB_ACCESS_TOKEN;
  return '';
}
